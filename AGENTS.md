...
nicht freigeschaltet), Secrets ausschließlich als Supabase-Edge-Function-Secret, CI-Validierung in
`.github/workflows/pr-check.yml` mit Lint/Typecheck/Build/Vitest/Deno-Tests/Migrationsvalidierung.
